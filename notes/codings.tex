...
\section*{Semantics}
\label{sec:org7434ee1}
\begin{itemize}
\item a location \(l\), specifies the location that the encoding is referring to,
this could be a slide, a number line etc.
\item a Level \(g\), Specifies the level of abstraction for a given step:
\begin{description}
...
\item a Role \(r\), specifies how the Level is trying to be reached, denotes the
...
\begin{itemize}
\item a Notation \(n\), specifies the form of the role:
\begin{description}
