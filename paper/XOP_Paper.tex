...
\todo{Introduce Bellack's system, etc.}
...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \begin{enumerate}
      \item \emph{Definining-Denotative} (DED): The object referent of term
      \item \emph{Defining-Connotative} (DEC): A statement about the defining
        characteristics of some class or term
...
\todo{come up with a relevant coding example and give the interpretation}
\begin{verbatim}
