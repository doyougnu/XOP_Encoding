...
visualization~\cite{Gloor92,Gloor98,HDS02,?}, and several tools exist to
...
\todo{determine the formatting of this table, do we want to show totals?}
\begin{figure}
\centering\footnotesize
\begin{tabular}{r|r|l}
\multicolumn{2}{c}{Frequency} & \\
\multicolumn{1}{c}{File Type}
  & \multicolumn{1}{c}{Notes}
  & \multicolumn{1}{l}{Teaching cycle} \\ \hline
ppt & 65  & STR \\
ppt & 8   & SOL \\
ppt & 49  & STR EXP \\
ppt & 19  & STR EXP \ldots \\
ppt & 3   & SOL EXP \\
ppt & 1   & SOL EXP \ldots \\
...
word & 10  & SOL \\
word & 78 & STR EXP \\
word & 31  & STR EXP \ldots \\
word & 1   & SOL EXP \\
word & 0   & SOL EXP \ldots \\
...
ensure transparency and openness, the reader may find all raw results, and any
post-processing scripts published online \todo{make repo holding raw results and
  R code}.
...
believe, serves as such an organizing tool. In our view, it forms the basis of
the semantics for the DSL.
...
initiatory moves would be of a form ``STR/BKG/XPL'' or perhaps ``STR/MOT/VIS'',
...
for mergesort is given visually. The typological pedagogical moves therefore
structure the semantics of the DSL by describing \emph{what this move needs to
...
is extensible and not constrained by the design.

\subsubsection{Dealing with Cadence}
Cadence in such a DSL could be supported through the fourth category of the
