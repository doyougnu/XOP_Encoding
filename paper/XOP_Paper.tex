...
typology between coders in section \todo{name section where we present agreement
  data}.
...
Explanation-Oriented DSL. One which would allow a static document of some sort
\emph{to participate} in the language game. The modified typology presented in
this paper serves as a paradigm from which to design such a DSL in a
